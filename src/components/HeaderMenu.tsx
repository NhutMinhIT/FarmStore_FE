                        ...
                        <div className={isDropdownOpen ? "block md:block w-full md:w-auto relative" : "hidden md:block w-full md:w-auto"} id="mobile-menu">
                            <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                                ...
                                <li>
                                    ...
                                    <div id="dropdownNavbar" className={isDropdownOpen ? "bg-white text-base list-none divide-y z-50 divide-gray-100 rounded shadow my-4 w-44 absolute" : "hidden bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44"} onClick={(e) => e.stopPropagation()} style={{ top: "100%" }}>
